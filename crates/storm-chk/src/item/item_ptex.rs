...
// =============================================================================
// Brood War Tech Restrictions
// =============================================================================

/// This section is identical to [`PTEC`][super::Ptec] section except it uses
...
pub struct Ptex {
  pub player_allowed: [[u8; TechId::BROOD_WAR]; Player::TOTAL],
  pub player_studied: [[u8; TechId::BROOD_WAR]; Player::TOTAL],
  pub global_allowed: [u8; TechId::BROOD_WAR],
  pub global_studied: [u8; TechId::BROOD_WAR],
  pub global_default: [[u8; TechId::BROOD_WAR]; Player::TOTAL],
}
...
impl From<Ptex> for Item {
  #[inline]
  fn from(other: Ptex) -> Self {
    Self::Ptex(Box::new(other))
  }
}

impl ParseChunk for Ptex {
  const TYPE: ChunkType = ChunkType::Sized(0x688);
